...
export const Task = () => {
    ...
    const posttask = ()=> {
        axios.post('https://todolist-crud-p9gc.vercel.app/tasks', {
            name: taskname,
    ...
    const deletetask = async (e: Id)=>{
        axios.post('https://todolist-crud-p9gc.vercel.app/delete', {
            deleted: e
        }).then((res)=>{
            notifydeleted()
            update()
    ...
    const completetask = async (e: Id)=>{
        await  axios.post('https://todolist-crud-p9gc.vercel.app/complete', {
            complete: e
        }).then(()=>notifycomlete())
        update()
    }
    ...
    const modifyname = (e: modify)=>{
        ...
        axios.post('https://todolist-crud-p9gc.vercel.app/edit', {
            edit: e,
            name: value
    ...
    const update = () => {
        axios.post('https://todolist-crud-p9gc.vercel.app/consult', {
            user: login.loggeduser
        }).then((res)=>{
